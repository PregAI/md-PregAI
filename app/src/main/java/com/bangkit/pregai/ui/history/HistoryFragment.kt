...
import pregai.R
import pregai.databinding.FragmentHistoryBinding
import pregai.databinding.ItemHistoryLayoutBinding
            ...
            fun bind(metrics: PostProcessMetrics) {
                binding.apply {
                    ...
                    val category = when (metrics.category) {
                        "beginner" -> "Focus & Mindfulness"
                        "intermediate" -> "Good for Pregnant Women"
                        "advanced" -> "Relaxation"
                        else -> "N/A"
                    }

                    poseLevel.text = "Recommended Training: $category"
